module github.com/tanjunchen/tanjunchen-scheduler
...
require (
	...
	k8s.io/cloud-provider v0.24.4 // indirect
	k8s.io/component-helpers v0.24.4 // indirect
	k8s.io/csi-translation-lib v0.24.4 // indirect
	k8s.io/kube-openapi v0.0.0-20220328201542-3ee0da9b0b42 // indirect
	k8s.io/kube-scheduler v0.0.0 // indirect
	k8s.io/mount-utils v0.24.4 // indirect
